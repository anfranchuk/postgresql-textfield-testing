...
| Таблица | Тип данных | Индекс | Длина строк | Записей | Размер таблицы | Размер индексов | Общий размер | Ср. размер записи |
|---------|------------|--------|-------------|---------|----------------|-----------------|--------------|-------------------|
| table1 | VARCHAR | Да | 1-100 | 2,000,000 | 167.12 МБ | 232.31 МБ | 399.51 МБ | 87.62 Б |
| table2 | VARCHAR | Нет | 1-100 | 2,001,000 | 167.04 МБ | 42.88 МБ | 210.00 МБ | 87.53 Б |
